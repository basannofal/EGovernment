                ...
                <div class="sales-boxe">
                    <div class="recent-sales box">
                        <div style={{ display: "flex", justifyContent: "space-between" }}>
                            ...
                            <div class="title">Mutiadmin Information</div>
                            <div><NavLink to={`/addmultiadmin/${id}`} > <a><button className='btn btn-primary'>Add Sub Admin <i class='bx bx-plus'></i></button> </a></NavLink> </div>
                        </div>
                        <hr />
                        ...
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Admin Previgious</th>
