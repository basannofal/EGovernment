...
function Panchayat() {
  ...
  const filterBySearch = (event) => {
    ...
    const results = temp.filter((user) => {
      return user.villagename.toLowerCase().indexOf(keyword.toLowerCase()) !== -1;
  ...
  const Editdata = async (obid) => {
    navigate(`/addpanchayat/${id}/${obid}`, { replace: true })
  }
      ...
      <section class="home-section">
        <nav>
          ...
          <div class="search-box">
            <input type="text" placeholder="Enter Village Name..." onChange={filterBySearch} />
