...
function Notice() {
    ...
    const filterBySearch = (event) => {
      ...
      const results = temp.filter((user) => {
        return user.noticename.toLowerCase().indexOf(keyword.toLowerCase()) !== -1;
    ...
    <section class="home-section">
        <nav>
            ...
            <div class="search-box">
                <input type="text" placeholder="Enter Notice Name..." onChange={filterBySearch} />
