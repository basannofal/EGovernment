...
function Department() {
    ...
    const filterBySearch = (event) => {
      ...
      const results = temp.filter((user) => {
        return user.deptname.toLowerCase().indexOf(keyword.toLowerCase()) !== -1;
    ...
    <section class="home-section">
        <nav>
            ...
            <div class="search-box">
                <input type="text" placeholder="Enter Department Name..." onChange={filterBySearch} />
            ...
            <div class="sales-boxe">
                <div class="recent-sales box">
                    <div style={{ display: "flex", justifyContent: "space-between" }}>
                        ...
                        <div><NavLink to={`/departmentadd/${id}`} > <a><button className='btn btn-primary'>Add Department <i class='bx bx-plus'></i></button> </a></NavLink> </div>
                    </div>
                    <hr />
